...
QT_MOC_LITERAL(6, 59, 12) // "startClicked"

    },
    "OptionsWidget\0sendOptions\0\0numRounds\0"
    "downCount\0roundLength\0startClicked"
};
...
void OptionsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendOptions((*reinterpret_cast< int(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2])),(*reinterpret_cast< int(*)>(_a[3]))); break;
        ...
        {
            typedef void (OptionsWidget::*_t)(int , int , int );
...
// SIGNAL 0
void OptionsWidget::sendOptions(int _t1, int _t2, int _t3)
{
